...
class Engine:
    ...
    def __init__(self, scene_map, hero):  # map and hero class passed here
        self.scene_map = scene_map
        self.hero = hero

    def play(self):
        current_scene = self.scene_map.opening_scene()  # comes from map class

        while True:
            print("\n--------------------")
            next_scene_name = current_scene.enter(self.hero)  # you enter scene here and output returns str - next one
            # run the instance of map you've created
...
class CentralCorridor(Scene):
    ...
    def enter(self, hero):
        ...
        action = input(""" ['shoot', 'dogdge', 'tell a joke']   >  """)
        ...
        if action == "tell a joke":
            ...
            print("Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf neaq gur ubhfr.")
...
class Final(Scene):
    ...
    def enter(self, hero):
        ...
        print(f"{hero.name}, You now came across the final boss {monster.name}! Let's fight!!!")
